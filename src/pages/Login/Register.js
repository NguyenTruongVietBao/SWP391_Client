            ...
            <div className="w-full md:max-w-md mt-6">
                <div className="card bg-white/5 p-6 backdrop-blur-2xl shadow-2xl rounded-lg px-4 py-4 mb-6 ">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type="text" className="rounded px-4 w-full py-2 bg-gray-100  border border-gray-300 mb-6 text-gray-700 placeholder-gray-700 focus:bg-white focus:outline-none" placeholder="Address" />
                        <div className='form-group'>
                            <input 
                                name="phone"
                        ...
                        <div className="flex items-center justify-center">
                            <button className="bg-gray-800 text-gray-200  px-3 py-2 rounded">Đăng ký</button>
                            <div className="form-group">
