                        ...
                        <div className="md:flex items-center justify-between">
                            ...
                            <div className="w-full md:w-1/2 mr-auto" style={{ textShadow: '0 20px 40px hsla(0,0%,0%,111)' }}>
                                ...
                                <h2 className="text-2xl font-bold text-white tracking-wide">
                                    <span className="text-black">chưa có</span> tài khoản ?
                                </h2>
                                <p className="text-white">.</p>
                                <span className="mt-9 text-white">
                                    <Link to="/register" className="text-black rounded-xl text-lg ml-2 font-bold py-2 px-2 bg-mathcha-orange hover:bg-mathcha">Đăng ký</Link>
                                </span>
                            </div>
                            {/* Right */}
                                ...
                                <div className="card bg-white/5 p-6 backdrop-blur-2xl shadow-2xl rounded-lg px-4 py-4 mb-6">
                                    <form>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button onClick={handleLogin} className="bg-gray-800 text-gray-200 font-bold px-3 py-3 rounded" type='submit'>
                                                Đăng nhập
                                            </button>
                                        </div>
