                ...
                <div id="content" className="bg-black/10 col-span-9 rounded-lg p-6">
                    ...
                    <div id="manage-course">
                        <div className='flex items-center justify-between'>
                            ...
                            <Button className="inline-flex items-center gap-2 rounded-md bg-gradient-to-br from-black/60 via-black/80 to-black/60 py-1.5.6 font-semibold text-white shadow-inner shadow-white/10 focus:outline-none data-[hover]:bg-gray-600 data-[open]:bg-gray-700 data-[focus]:outline-1 data-[focus]:outline-white">
                            ...
                            <table className="w-full whitespace-nowrap">
                                <thead className="bg-gradient-to-br from-black/80 via-black/60 to-black/70 text-white/90">
                                    <tr>
                                        ...
                                        <th className="text-center py-3 px-2">Họ và tên</th>
                                        <th className="text-center py-3 px-2">Điện thoại</th>
                                        <th className="text-center py-3 px-2">Email</th>
                                        <th className="text-center py-3 px-2">Khóa của con</th>
                                ...
                                <tbody>
                                    {students.map((data, index) => (
                                        <tr key={index} className="border-b border-gray-700">
                                            ...
                                            <td className="py-3 px-2 text-center font-bold"><span>{data.last_name}{data.first_name} </span></td>
                                            ...
                                            <td className="py-3 px-2 text-center">
                                                <div className="inline-flex items-center space-x-3">
                                                    ...
                                                    <Link onClick={() => openDeleteConfirmation(data.student_id)} title="Delete" className="hover:text-white">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
