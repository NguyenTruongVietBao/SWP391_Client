...
export default function ParentPage() {
  ...
  return (
    <div className="flex text-gray-800 flex-col items-center w-full overflow-x-hidden">
        <div
            className="bg-gradient-to-r from-mathcha via-white to-mathcha flex flex-col gap-[100px] justify-center items-center w-full h-full">
            <div className="flex items-center justify-center w-full h-full">
                <img src={"/assets/trang chu-02.png"} alt="a" className="w-full h-full object-contain"/>
            </div>
            {user !== null && (
                <Link to={'/my-course'}
                      className="flex text-lg font-bold text-center px-[30px] py-3 border-2 bg-mathcha border-mathcha-orange rounded-[68px] hover:text-white duration-1000 hover:bg-mathcha-green hover:border-white"
                    ...
                    <div className=" flex flex-col gap-[50px] max-w-[1180px] justify-center w-full ">
                        <div className=" flex justify-between items-center">
                            ...
                            {!showAll && courses.length > 6 && (
                                <Link to={'/course'}
                                      className="flex text-lg font-bold text-center px-[30px] py-3 border-2 border-mathcha-orange rounded-[68px] hover:text-white duration-1000 hover:bg-[#2D4263] hover:border-white"
                                      font="text-white font-normal">
                                    Xem thêm
                                </Link>
                            )}
                        ...
                        <div>
                            <div
                                className="items-center justify-center flex flex-wrap gap-[30px] md:gap-[50px] lg:gap-[83px] md:px-0 px-[4%] w-full ">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <button onClick={handleClosePopup}
                                                    className="text-black text-right w-full text-4xl">
                                                &times;
                                            </button>
                    ...
                    <div className="items-center w-full flex flex-col gap-9 bg-mathcha rounded-3xl py-3">
                        ...
                        <div className="flex items-center justify-between gap-10">
                            <div className="text-center w-1/4">
                                ...
                                <p>Chương trình Khởi đầu trang bị cho trẻ nền tảng vững chắc về kiến thức Toán và thúc
                                    đẩy quá trình phát triển Tư duy.</p>
                            </div>
                            <div className="text-center w-1/4">
            ...
            {/* Liên hệ  */}
            <div id={'tu-van'}
                 className="flex flex-col items-center justify-center p-6 md:p-10 backdrop-blur-sm bg-mathcha-green/30 rounded-2xl mb-10">
                <div className="text-3xl md:text-5xl font-Cormorant font-bold leading-tight mb-10 text-center">
                    Đăng ký tư vấn
                </div>
