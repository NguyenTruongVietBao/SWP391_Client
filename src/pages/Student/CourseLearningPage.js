      ...
      <div className="flex flex-row py-12 px-10 ">
        ...
        <div className="w-2/12 mr-10">
          <div className="bg-white rounded-xl shadow-lg mb-6 px-6 py-4 items-center justify-center">
            <a
              href="/learning"
              className="flex text-gray-600 hover:text-black my-4 mb-8 w-full"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <a
              href="/learning"
              className="flex text-gray-600 hover:text-black mt-8 my-4 mb-8 w-full"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <a
              href="/student"
              className="flex text-gray-600 hover:text-black my-4 w-full "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div className="bg-white rounded-xl shadow-lg mb-6 px-6 py-4">
            <a
              href
              className=" flex text-gray-600 hover:text-black my-4 w-full mb-8"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <div className="w-10/12 ">
            <div className="bg-no-repeat bg-blue-50 border-4 border-black rounded-xl w-full h-120 py-3 flex flex-col items-center justify-center">
              <p className="text-5xl text-indigo-900 text-center mb-6">
                <strong>Chương 1 - Hello world!</strong>
              </p> 
              <iframe
                className='item-center'
                width="1020"
                height="574"
                src="https://www.youtube.com/embed/Gvs2UwzD6xw"
                title="chào buổi sáng cùng AMEE 🌞 | AMEE&#39;s playlist #1"
                frameborder="0"
