...
export default function StudentPage() {
  return (
    <div className="bg-mathcha h-full">
        {/* Navbar */}
        ...
        {/* Main */}
        <div className="flex flex-row pt-12 px-10 ">
            {/* Menu */}
