    ...
    useEffect(() => {
        const fetchEnrollmentId = async () => {
            try {
                ...
                const resCourse = await api.get(`/course/${courseId}`);
                ...
                <div className="w-3/12 mr-10">
                    <div className="w-full">
                        <div className="mx-auto w-full rounded-xl bg-yellow-100 border-4 border-black">
                            <h1 className="text-4xl my-4 font-bold text-center">FINAL EXAM</h1>
                            <h1 className="text-2xl my-4 font-bold text-center">Chủ đề: {course.title}</h1>
