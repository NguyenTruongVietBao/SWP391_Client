...
export default function CreatePage() {
  ...
  return (
      <div className="antialiased bg-orange-50 w-full min-h-screen relative py-4">
                  ...
                  <div>
                    <form onSubmit={handleAddCourse} className={'mr-7'}>
                      ...
                      <div className={''}>
                        ...
                        <button
                            type="button"
                            className="mt-4 mb-6 px-4 py-2 bg-mathcha-green text-white rounded-lg hover:bg-black transition duration-200"
        ...
        {isModalOpen && <CategoryModal closeModal={() => setIsModalOpen(false)} />} {/* Render modal conditionally */}
      </div>
  )
}