                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:mt-0">
                          {/* title */}
                            ...
                            <div className="flex mt-10">
                                <span className="flex justify-start text-2xl font-bold text-white bg-red-600 border-0 py-2 px-4 focus:outline-none hover:bg-red-00 rounded">$ {course.discount_price}.000</span>
                            </div>
                        </div>
                    </div>
                    {/* Bot */}
