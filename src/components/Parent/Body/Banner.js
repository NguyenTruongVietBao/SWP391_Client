      ...
      <div className="bg-mathcha flex flex-col items-center justify-center w-full">
        <div className=" md:flex items-center justify-between  w-full">
            {/* <div className="text-start flex flex-col gap-2.5 sm:gap-3 md:gap-5 px-[4%] xl:px-0 md:max-w-[430px] lg:max-w-[518px] w-full ">
              <div className="text-mathcha-green font-Cormorant text-[25px] sm:text-[40px] md:text-[50px] lg:text-[75px] md:leading-[70px] lg:leading-[87px] font-medium tracking-[0.03em]">
                Improve your{" "}
                <span className="text-mathcha-orange underline">
                  Math
                </span>
                <div>{" "}with</div>
                <span className="text-mathcha-orange underline">{" "}Mathcha.edu</span>
              </div>
